...
class DataValidation:
    ...
    def __init__(self,
        ...
        try:
            ...
            # Read schema.yaml using constant path
    ...
    def detect_dataset_drift(self, base_df, current_df, threshold=0.05) -> dict:
        try:
            status = True
            report = {}
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        try:
            ...
            if not status:
                 error_message += "Train dataframe missing/invalid numerical columns.\n"

            status = self.validate_numerical_columns(dataframe=test_dataframe)
            if not status:
                 error_message += "Test dataframe missing/invalid numerical columns.\n"      
